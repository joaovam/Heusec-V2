 ...
 */
!function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);else{var a;"undefined"!=typeof window?a=window:"undefined"!=typeof global?a=global:"undefined"!=typeof self&&(a=self),a.hsimp=e()}}(function(){return function e(a,r,o){function n(s,t){if(!r[s]){if(!a[s]){var l="function"==typeof require&&require;if(!t&&l)return l(s,!0);if(i)return i(s,!0);var c=new Error("Cannot find module '"+s+"'");throw c.code="MODULE_NOT_FOUND",c}var d=r[s]={exports:{}};a[s][0].call(d.exports,function(e){var r=a[s][1][e];return n(r||e)},d,d.exports,e,a,r,o)}return r[s].exports}for(var i="function"==typeof require&&require,s=0;s<o.length;s++)n(o[s]);return n}({1:[function(e,a,r){a.exports={"ASCII Lowercase":["[a-z]",26],"ASCII Uppercase":["[A-Z]",26],"ASCII Numbers":["\\d",10],"ASCII Top Row Symbols":["[-!@£#$%^&*()=+_]",15],"ASCII Other Symbols":["[\\s\\?\\/\\.>,<`~\\|;:\\]}\\[{'\"\\\\]",19],"Unicode Latin 1 Supplement":["[\\u00A1-\\u00A2\\u00A4-\\u00FF]",93],"Unicode Latin Extended A":["[\\u0100-\\u017F]",128],"Unicode Latin Extended B":["[\\u0180-\\u024F]",208],"Unicode Latin Extended C":["[\\u2C60-\\u2C7F]",32],"Unicode Latin Extended D":["[\\uA720-\\uA7FF]",29],"Unicode Cyrillic Uppercase":["[\\u0410-\\u042F]",32],"Unicode Cyrillic Lowercase":["[\\u0430-\\u044F]",32]}},{}],2:[function(e,a,r){"use strict";var o=e("hsimp-library"),n={},i=o.prop(0),s=o.prop(1),t=function(e){var a={},r=0,t=[];if(!o.isString(e))throw Error("CharacterSet: Invalid type");return o.forEach(function(a,o){e.match(i(a))&&(t.push(o),r+=s(a))},n),a.getSets=function(){return t},a.getPossibleCharacters=function(){return r},a};t.setCharacterSets=function(e){n=e},a.exports=t},{"hsimp-library":10}],3:[function(e,a,r){a.exports={common:{name:"Senha comum: no top {{ value }} senhas mais usadas",message:"Sua senha é muito comum de ser usada. Seria quebrada quase instantaneamente."},xkcd:{name:"xkcd",message:"Eu suspeito que os crackers de senha possam estar ligados a este agora..."},jeff:{name:"Sempre tem uma porta dos fundos...",message:'"O cara que criou o software se chamava Fulano Fulan Fula. Nascido em Tal, 01-Janeiro-2000."'},lengthVeryShort:{name:"Tamanho: Muito curto",message:"Sua senha é muito curta. Quanto mais longa a senha, mais segura ela será."},possiblyWord:{name:"Possivelmente uma palavra",message:"Sua senha parece ser uma palavra ou nome no dicionário. Se é um nome com significado pessoal, pode ser fácil adivinhar. Se for uma palavra do dicionário, pode ser quebrada rapidamente."},onlyNumbers:{name:"Variedade de caracteres: apenas números",message:"Sua senha contém apenas números. Isso reduz drasticamente o número de combinações possíveis."},wordAndNumber:{name:"Possivelmente uma palavra e um número",message:"Sua senha parece ser apenas uma palavra e alguns dígitos. Esse é um padrão muito comum e seria quebrado muito rapidamente."},lengthShort:{name:"Tamanho: Curto",message:"Sua senha é bastante curta. Quanto mais longa a senha, mais segura ela será."},justLetters:{name:"Variedade de caracteres: Apenas letras",message:"Sua senha contém apenas letras. Adicionar números e símbolos pode tornar sua senha mais segura."},noSymbols:{name:"Variedade de caracteres: Sem símbolos",message:"Sua senha contém apenas números e letras. Adicionar um símbolo pode tornar sua senha mais segura. Não esqueça que muitas vezes você pode usar espaços nas senhas."},telephone:{name:"Possivelmente um número de telefone / data",message:"Sua senha parece ser um número de telefone ou uma data. Se é e tem significado pessoal, pode ser muito fácil para alguém adivinhar."},repeatedPattern:{name:"Padrão repetido",message:"Caracteres ou padrões repetidos podem tornar sua senha mais previsível."},nonStandardCharacters:{name:"Variedade de caracteres: caracteres não padrão",message:"Sua senha contém um caractere que não é do teclado. Isso deve torná-lo mais seguro."},lengthLong:{name:"Tamanho: Longo",message:"Sua senha tem mais de dezesseis caracteres."}}},{}],4:[function(e,a,r){"uso estrito";var o,n=e("hsimp-library"),i=[],s=function(e){return n.filter(function(e){return e},n.map(function(a){return a(e)},n.reduce(function(e,a){return e.concat(a.get())},[],i)))},t=function(e){if(o.hasOwnProperty(e.id)){var a=o[e.id];return{level:e.level,name:e.value?a.name.replace("{{ value }}",e.value):a.name,message:e.value?a.message.replace("{{ value }}",e.value):a.message}}throw new Error("verificador: Entrada de dicionário ausente "+e.id)},l=function(e){if(!o)throw new Error("verificador: dicionário não definido");var a,r={},i=["highlight","insecure","warning","achievement","notice"];if(!n.isString(e))throw Error("checker: Invalid type");return a=n.map(t,s(e)).sort(function(e,a){var r=function(e){var a=i.indexOf(e.level);return-1===a?i.length:a};return r(e)-r(a)}),r.isInsecure=function(){return n.some(function(e){return"insecure"===e.level},a)},r.hasWarnings=function(){return n.some(function(e){return"warning"===e.level},a)},r.hasAchievements=function(){return n.some(function(e){return"achievement"===e.level},a)},r.getChecks=function(){return a},r};l.setDictionary=function(e){o=e},l.setChecks=function(e){var a=new Error("setChecks takes an array of check objects");if(!n.isArray(e))throw a;e.forEach(function(e){if(!n.isFunction(e.get))throw a}),i=e},a.exports=l},{"hsimp-library":10}],5:[function(e,a,r){"use strict";var o=e("hsimp-library"),n=function(e){if(!o.isFunction(e))throw new Error("Check is not a function");var a={},r=[];return a.setDictionary=function(e){r=e},a.get=function(){return e(r)},a};a.exports=n},{"hsimp-library":10}],6:[function(e,a,r){"use strict";var o=e("hsimp-library"),n=e("../check");a.exports=n(function(e){return[function(a){var r;return a=a.toLowerCase(),o.forEach(function(e,o){if(e===a)return r=5*Math.ceil((o+1)/5),!1},e),!!r&&{level:"insecure",id:"common",value:r}}]})},{"../check":5,"hsimp-library":10}],7:[function(e,a,r){"use strict";var o=e("hsimp-library"),n=e("../check");a.exports=n(function(e){return o.map(function(e,a){var r=new RegExp(a);return function(a){return!!r.test(a)&&e}},e)})},{"../check":5,"hsimp-library":10}],8:[function(e,a,r){a.exports={"^correcthorsebatterystaple$":{level:"insecure",id:"xkcd"},"^jeff|geoff$":{level:"easteregg",id:"jeff"},"^.{1,6}$":{level:"warning",id:"lengthVeryShort"},"^[a-zA-Z]{1,16}$":{level:"warning",id:"possiblyWord"},"^[0-9]+$":{level:"warning",id:"onlyNumbers"},"^([a-zA-Z]+[0-9]+|[0-9]+[a-zA-Z]+)$":{level:"warning",id:"wordAndNumber"},"^.{7,9}$":{level:"warning",id:"lengthShort"},"^[A-Za-z]+$":{level:"notice",id:"justLetters"},"^(?:\\d+[a-zA-Z]|[a-zA-Z]+\\d)[a-zA-Z\\d]*$":{level:"notice",id:"noSymbols"},"^[\\-\\(\\)\\.\\/\\s0-9]+$":{level:"warning",id:"telephone"},"(.+)\\1{2,}":{level:"warning",id:"repeatedPattern"},"[^A-Za-z0-9\\u0000-\\u007E]":{level:"achievement",id:"nonStandardCharacters"},"^.{17,}$":{level:"achievement",id:"lengthLong"}}},{}],9:[function(e,a,r){
